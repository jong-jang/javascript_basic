...
const cBtnMembers = btsMembers.map((x) => new MaleIdol(x.name, x.year));
console.log(cIveMembers);
console.log(cBtnMembers);

const iveGroup = new IdolGroup('아이브', cIveMembers);
const btnGroup = new IdolGroup('방탄', cBtnMembers);

console.log(iveGroup);
console.log(btnGroup);

const korea = new Country('대한민국', [iveGroup, btnGroup]);
console.log(korea);
